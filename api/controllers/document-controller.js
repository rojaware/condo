...
async function getDocs() {
  try {
    ...
    let items = await pool.request().query("SELECT id, name from DOCUMENTS");
...
async function getDocsByPropertyOrTenant(name) {
  try {
    ...
    let item = await pool.request()
      ...
      .query("SELECT id, name from DOCUMENTS where propertyName = @name OR tenantName = @name");
...
async function getDocById(id) {
  try {
    ...
    let item = await pool.request()
      .input('id', sql.Int, id)
      .query("SELECT id, name, data from DOCUMENTS where id = @id");
